 ...
 *
 */
export declare function ng2LazyLoadBuilder(state: StateObject, parent: BuilderFunction): ((transition: Transition) => Promise<LazyLoadResult>) | ((transition: Transition, state: StateDeclaration) => Promise<StateDeclaration[]>);
