...
export declare function stateService(r: UIRouter): void;
export declare function transitionService(r: UIRouter): void;
export declare function urlMatcherFactory(r: UIRouter): void;
export declare function urlRouter(r: UIRouter): void;
export declare function viewService(r: UIRouter): void;
export declare function stateRegistry(r: UIRouter): void;
export declare function globals(r: UIRouter): void;
